...
//        Access.initializeTable();
        ...
        context.getConf().set("spark.executor.heartbeatInterval", "12000");
        context.getConf().set("spark.network.timeout", "10000");
        ...
        sameDateArticle.foreachPartition(partition -> {
            ...
            partition.forEachRemaining(article -> {
                ...
                if (randomValue <= article._2._1._3()) {
                    ...
                    System.out.println(articleRecommendation + " THIS WAS THE RECOMMENDATION");
...
//        logger.info("Shutting down");
    ...
    public static String[] copy_of_args;
